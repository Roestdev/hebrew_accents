...
### 3 Major categories
   ...
   Within each accent system there are two major categories of Masoretic accents:

  - `Disjunctive accents`
  
    Function as “breaks” or pause in the verse. Depending of the relative weight of the accent the pause can be longer or shorter.
    Separate larger syntactic units.

  - `Conjunctive accents`

    Bind words together, similar to conjunctions within a verse.
    
  *The same Unicode code‑point can act as a disjunctive accent in the Twenty‑One Books and as a conjunctive accent in the Three Books.*

### 4 Small technical note on encoding

    The same (UTF-8) accent can be disjunctive in the "Twenty-One Books" and conjunctive in the "Three Books".

    Because the same visual glyph can serve different grammatical functions, a single Unicode code‑point may map to multiple traditional accents.

    A Hebrew Accent may consists of one or two UTF-8 code points

### 5 Further Reading
    
   For a deeper dive into the theory, history, and practical application of these accents, you may consult some of the books/articles listed below. 
   ```
   Note: This list is definitly incompleet.
   ```

  - [Unicode Block Hebrew](<https:://www.unicode.org/charts/PDF/U0590.pdf>) (chapter 9.1 - section: Meteg).
  ...
  - [Hebrew Cantillation](<https:://en.wikipedia.org/wiki/Hebrew_cantillation>)  (wikipedia)
