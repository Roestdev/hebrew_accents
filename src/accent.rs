...
impl PoetryAccent {
    ...
    fn details(&self) -> HebrewAccentDetails {
        match self {
            ...
            PoetryAccent::OlehWeYored => HebrewAccentDetails {
            ...
            PoetryAccent::Atnach => HebrewAccentDetails {
                ...
                bhs_meaning:"pause, rest".to_string(), 
                alt_bhs_name: None,
                alt_bhs_hebrew: None,
                alt_bhs_meaning: None,
                acc_type: AccentType::Primairy,
            ...
            PoetryAccent::Galgal => HebrewAccentDetails {
                ...
                alt_bhs_name: Some("Yerach (ben yomo)".to_string()),
                alt_bhs_hebrew: Some("יֵרֶח בֶּן יוֹמ֪וֹ".to_string()),
                alt_bhs_meaning: Some("day-old moon".to_string()),
                acc_type: AccentType::Primairy,
                acc_category: AccentCategory::Conjunctive,
                code_point_1: CP_YERAH_BEN_YOMO,
                code_point_2: None,
