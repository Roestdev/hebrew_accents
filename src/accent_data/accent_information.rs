...
use crate::codepoints::{
    CODEPOINT_DARGA, CODEPOINT_DEHI, CODEPOINT_ETNAHTA, CODEPOINT_GERESH, CODEPOINT_GERSHAYIM, CODEPOINT_ILUY, CODEPOINT_MAHAPAKH, CODEPOINT_MAQAF, CODEPOINT_MERKHA, CODEPOINT_MERKHA_KEFULA, CODEPOINT_METEG, CODEPOINT_MUNAH, CODEPOINT_OLE, CODEPOINT_PASEQ, CODEPOINT_PASHTA, CODEPOINT_PAZER, CODEPOINT_QADMA, CODEPOINT_QARNEY_PARA, CODEPOINT_REVIA, CODEPOINT_SEGOL, CODEPOINT_SHALSHELET, CODEPOINT_SILLUQ, CODEPOINT_SOPH_PASUQ, CODEPOINT_TELISHA_GEDOLA, CODEPOINT_TELISHA_QETANA, CODEPOINT_TEVIR, CODEPOINT_TIPEHA, CODEPOINT_YERAH_BEN_YOMO, CODEPOINT_YETIV, CODEPOINT_ZAQEF_GADOL, CODEPOINT_ZAQEF_QATAN, CODEPOINT_ZARQA, CODEPOINT_ZINOR, TRADITION_NAMES_AZLA_LEGARMEH, TRADITION_NAMES_DARGA, TRADITION_NAMES_DEHI, TRADITION_NAMES_ETNAHTA, TRADITION_NAMES_GERESH, TRADITION_NAMES_GERSHAYIM, TRADITION_NAMES_ILUY, TRADITION_NAMES_LEGARMEH, TRADITION_NAMES_MAHAPAKH, TRADITION_NAMES_MAQAF, TRADITION_NAMES_MEHUPPAKH_LEGARMEH, TRADITION_NAMES_MERKHA, TRADITION_NAMES_MERKHA_KEFULA, TRADITION_NAMES_METEG, TRADITION_NAMES_MUNAH, TRADITION_NAMES_OLEH_WEYORED, TRADITION_NAMES_PASEQ, TRADITION_NAMES_PASHTA, TRADITION_NAMES_PAZER, TRADITION_NAMES_QADMA, TRADITION_NAMES_QARNEY_PARA, TRADITION_NAMES_REVIA, TRADITION_NAMES_SEGOL, TRADITION_NAMES_SHALSHELET, TRADITION_NAMES_SHALSHELET_GADOL, TRADITION_NAMES_SILLUQ, TRADITION_NAMES_SOPH_PASUQ, TRADITION_NAMES_TELISHA_GEDOLA, TRADITION_NAMES_TELISHA_QETANA, TRADITION_NAMES_TEVIR, TRADITION_NAMES_TIPEHA, TRADITION_NAMES_TSINNORIT_MAHPACH, TRADITION_NAMES_TSINNORIT_MERKHA, TRADITION_NAMES_YERAH_BEN_YOMO, TRADITION_NAMES_YETIV, TRADITION_NAMES_ZAQEF_GADOL, TRADITION_NAMES_ZAQEF_QATAN, TRADITION_NAMES_ZINOR,
};
...
pub(crate) const SHALSHELET_GADOL_INFO: AccentMetaData = AccentMetaData {
    ...
    alternate_names: None,
    max_word_span: Some(MaxWordSpan::OneWord),
notes: Some(r#"TODO"#),    kind: Kind::Primary,
    accent_category: Category::Disjunctive,
    word_stress: WordStress::Im,
